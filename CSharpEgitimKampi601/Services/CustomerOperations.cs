...
namespace CSharpEgitimKampi601.Services
{
    public class CustomerOperations
    {
        ...
        public void DeleteCustomer(string id)
        {
            var connection = new MongoDbConnection();
            var customerCollection = connection.GetCustomersCollection();
            var filter = Builders<BsonDocument>.Filter.Eq("_id", ObjectId.Parse(id)); //Silmek istediğimiz değeri buluyoruz.
        ...
        public void UpdateCustomer(Customer customer)
        {
            ...
            var filter = Builders<BsonDocument>.Filter.Eq("_id", ObjectId.Parse(customer.CustomerId)); //Güncellenecek id yi buluyoruz.
